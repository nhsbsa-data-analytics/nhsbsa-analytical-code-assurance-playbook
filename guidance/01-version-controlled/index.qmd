...
description: "Version control is all about tracking code changes over time."
---

> ## Suggested reading
>
> * [AF Duck book: Version control][duck-book-version-control]
> * [NHSE RAP Community of Practice: Introduction to Git][nhse-rap-cop-git]


## At a glance

Version control (Git) is an essential tool helps teams to safely collaborate and make their code resilient by tracking changes, enabling branching, and ensuring code is transparent, auditable and reproducible. 
...
Version control is a way to track line-by-line changes to source code over time. Version control [keeps an audit trail of changes](https://best-practice-and-impact.github.io/qa-of-code-guidance/version_control.html#keep-an-audit-trail-of-changes) and allows any point in history to be restored. 
...
* safe to collaborate and work in parallel on through branching, preventing clashes and enforcing [peer review][peer-review]
...
* [peer review][peer-review] -- use pull/merge request functionality from Git hosting providers to review code before merging changes
...
Guidance on setting your config and how user accounts for git providers should be created are available on the [NHSBSA Confluence][nhsbsa-confluence-github-accounts].
...
Code reviews should be conducted in line with our [peer review][peer-review] guidance.
...
The optional body should contain details of specific changes if required. The optional footer should contain [git-trailer][git-trailer-info] formatted meta-information
...
[tested]: /guidance/02-tested/index.qmd
[documented]: /guidance/06-documented/index.qmd
[open-source]: /guidance/07-open-source/index.qmd
[duck-book-version-control]: https://best-practice-and-impact.github.io/qa-of-code-guidance/version_control.html
[nhse-rap-cop-git]: https://nhsdigital.github.io/rap-community-of-practice/training_resources/git/introduction-to-git/
[nhsbsa-confluence-github-accounts]: https://bsa2468.atlassian.net/wiki/spaces/KB/pages/5801672736/Github+User+Accounts
[atlassian-git-rebase]: https://www.atlassian.com/git/tutorials/rewriting-history/git-rebase
[conventional-commits]: https://www.conventionalcommits.org/en/v1.0.0/
[git-trailer-info]: https://git-scm.com/docs/git-interpret-trailers