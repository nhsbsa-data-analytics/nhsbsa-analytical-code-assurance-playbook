...
* __transparency and auditability:__
Keeps a complete, attributed history of every change for full traceability

* __reproducibility:__
Ensures any past version of the code can be restored exactly

* __safe collaboration:__
Allows parallel work through branches, preventing clashes and enforcing peer review

* __rolling it back:__
Makes it easy to find problematic changes and revert to a stable version.

* __preventing work and data loss:__
Stores work safely in a remote repository, protecting against local failures.

* __facilitating knowledge sharing:__
Provides clear history and structure that help new team members understand the codebase.
