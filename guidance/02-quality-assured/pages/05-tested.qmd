...
Rigorous testing is fundamental to assuring quality of code. It builds confidence that results are [reproducible][reproducible] by ensuring code works as expected, and [allows anyone to easily verify this][transparent].

* **Unit Tests:** Focus on testing the smallest individual components, in isolation. They should be fast and numerous.
* **Integration Tests:** Verify that different components or modules work together as expected.
...
* **Maintain Tests:** Treat test code like production code – keep it [updated, refactor it, and remove obsolete tests][version-controlled].
