...
* For published content, documentation, and data: use the [Open Government Licence v3.0 (OGL v3)]. This should include a link to the licence agreement in the footer or main documentation.
