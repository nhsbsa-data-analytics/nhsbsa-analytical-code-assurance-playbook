...
* Feels well-organised and easy to navigate.
...
1. Start by splitting complex code into multiple ordered scripts grouped by concern (e.g. data build, cleaning, analysis, visualisation). Organise scripts so that the intended run order is clear — this alone improves navigability and makes [peer review][peer-review] easier.
