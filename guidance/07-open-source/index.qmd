---
title: "Open Source"
description: "Open source code is code that can be viewed, downloaded, used and changed by anyone."
---

## At a glance
Open source code is code that can be viewed, downloaded, used and changed by anyone. 
...
1. **Document your code:** Provide clear instructions for use, dependencies, and purpose. Ensure the code itself is written to be easy to understand and maintain, and include a `CONTRIBUTE` file to guide others who may want to contribute.
